...
export function MetricsSection() {
  return (
    <section className="px-4 py-10 sm:px-6 lg:px-8">
      <div className="mx-auto grid max-w-7xl gap-5 rounded-[2rem] border border-blue-100 bg-slate-950 px-6 py-8 text-white shadow-[0_25px_80px_rgba(15,23,42,0.28)] lg:grid-cols-3 lg:px-10">
        {metrics.map((metric) => (
